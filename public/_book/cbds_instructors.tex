...
\hypersetup{unicode=true,
            pdftitle={Instructor Resources for Cloud-Based Data Science},
            pdfauthor={Cloud-Based Data Science Team},
            pdfborder={0 0 0},
            breaklinks=true}
...
\addcontentsline{toc}{chapter}{Course 1: Introduction to Chromebook Data Science}
...
\addcontentsline{toc}{chapter}{Optional Course: How to Use a Chromebook}
...
\addcontentsline{toc}{section}{Exercise 2: Working on Google Docs offline}
...
\addcontentsline{toc}{section}{Exercise 3: Creating a Google calendar event and inviting others}
...
\addcontentsline{toc}{section}{Exercise 4: Subscribing to a Google Calendar}
...
\addcontentsline{toc}{section}{Exercise 5: Deleting and recovering a file on Google Drive}
...
\addcontentsline{toc}{section}{Exercise 6: Using a resume template on Google Doc}
...
\addcontentsline{toc}{section}{Exercise 7: Creating a Google Sheets document}
...
\addcontentsline{toc}{section}{Exercise 8: Creating a Google Slides document}
...
\addcontentsline{toc}{section}{Exercise 2: Creating a New Project and the Workflow}
...
\addcontentsline{toc}{section}{Exercise 1: Creating a new repository}
...
\addcontentsline{toc}{section}{Exercise 2: Adding an issue to a classmate's repository}
...
\addcontentsline{toc}{section}{Exercise 3: Deleting a repository}
...
\addcontentsline{toc}{section}{Exercise 4: Creating an RStudio project from a Github repository}
...
\addcontentsline{toc}{section}{Exercise 3: Basic Commands in R}
...
\addcontentsline{toc}{section}{Exercise 4: Creating a Data Frame}
...
\addcontentsline{toc}{section}{Exercise 5: Creating Lists in R}
...
\addcontentsline{toc}{section}{Exercise 6: Missing Values in R}
...
\addcontentsline{toc}{section}{Exercise 7: Reverse a String Function}
...
\addcontentsline{toc}{section}{Exercise 8: A simple function}
...
\addcontentsline{toc}{section}{Exercise 9: The scan function}
...
\addcontentsline{toc}{section}{Exercise 10: Function for the class of a data frame}
...
\addcontentsline{toc}{section}{Exercise 11: Function for the \# of times a value is repeated}
...
\addcontentsline{toc}{section}{Exercise 12: Cummulative sum function}
...
\addcontentsline{toc}{section}{Exercise 13: Cummulative sum function}
...
\includegraphics{cbds_instructors_files/figure-latex/unnamed-chunk-66-1.pdf}
...
\includegraphics{cbds_instructors_files/figure-latex/unnamed-chunk-67-1.pdf}
...
\includegraphics{cbds_instructors_files/figure-latex/unnamed-chunk-68-1.pdf}
...
\includegraphics{cbds_instructors_files/figure-latex/unnamed-chunk-69-1.pdf}
